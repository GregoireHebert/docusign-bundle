...
class SignTest extends TestCase
{
    public function testSign(): void
    {
        ...
        $eventDispatcherProphecy->dispatch(WebHookEvent::DOCUMENT_PRE_SIGNED, Argument::type(PreSignEvent::class))->shouldBeCalled();
    ...
    {
        $eventDispatcherProphecy = $this->prophesize(EventDispatcherInterface::class);
        $eventDispatcherProphecy->dispatch(WebHookEvent::DOCUMENT_PRE_SIGNED, Argument::type(PreSignEvent::class))->shouldNotBeCalled();
