...
//    }
    ...
    public function testICanSignAnEmbeddedDocument(): void
    {
        ...
        $client->takeScreenshot('build/screenshots/docusign.png');
        $crawler = $client->waitFor('#action-bar-btn-continue');
        $client->takeScreenshot('build/screenshots/continue.png');
        ...
        $client->takeScreenshot('build/screenshots/signature.png');
        ...
        $client->takeScreenshot('build/screenshots/finish.png');
        ...
        $client->takeScreenshot('build/screenshots/alert.png');
